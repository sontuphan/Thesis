...
\end{itemize}
\subsection{Overboungt và Oversold}
Overboungt dùng để định nghĩa trường hợp thị trường có mức cầu cao hơn mức cung, 
...
đặt bán, trường hợp này được xem là overboungt.\\\\
...
Với một perceptron đơn lẻ, tự thân nó không thể giái quyết được một bài toán 
...
\item $a(\sigma)$ là hàm hoạt động có dạng sigmoid, $a$ là vector của các hàm 
hoạt động\\
\[ a =
\begin{bmatrix}
a_1\\
